      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {estadisticas.map((estadistica, index) => (
            ...
            >
              <div className="text-5xl font-bold mb-2 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] transition-all duration-300 group-hover:scale-110 relative">
                <span className="relative inline-block animate-float">{estadistica.valor}</span>
              </div>
              <div className="text-lg font-medium text-[#F0F0F0] transition-all duration-300 group-hover:text-white">
